...
$result = mysqli_query($conn, "SELECT * FROM users WHERE uid='$uid' AND pwd='$pwd'");
  ...
  <body>
    ...
    <div class="container" style="margin-top:50px">
      ...
      <div class="starter-template">
        <h1>Login Portal</h1>
        <p class="lead">Registered users please login from this portal.</p>
      </div>
...
<form  method="POST" action="index.php?action=login">
  <div class="form-group">
    ...
    <br><br><br><br>
          <div class="col-xs-2">
<td><input type="submit" class="btn btn-success" name="login" value="Login"></td></div>
    <br><br><br><br>
     <div class="col-xs-4">
    <a href="index.htm">Not Yet Registered? Go Here.</a>
     </div>
</form>
